...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("goals", "Run repo-local goals engines and summarize their reports", "Session",
               args_hint="[start|status|report|monitor|schedule] <alias>",
               subcommands=(
                   "start", "status", "report", "monitor", "schedule", "watch",
                   "unschedule", "unwatch", "pause", "resume", "stop", "list",
               )),
